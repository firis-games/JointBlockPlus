...
public abstract class AbstractTileEntity extends TileEntity {
	...
	/**
	 * ログインのタイミングの同期に使われてる？ チャンクデータの同期のタイミングでつかわれてるっぽい SPacketChunkData
	 */
	@Override
	...
	/**
	 * Called when the chunk's TE update tag, gotten from {@link #getUpdateTag()},
	 ...
	 *
	 * @param tag
	 *            The {@link NBTTagCompound} sent from {@link #getUpdateTag()}
	 * 
	 *            チャンクのほう
	 */
	@Override
	 ...
	 */
	/**
	 * クライアントサイドでgetDescriptionPacketの処理のあとに呼び出されるとおもわれる NBTからクラス情報への反映等を行う?
	 * 
	 * 
